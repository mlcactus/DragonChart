if (!window.DChart) {
    ...
    DChart.Const.Skins.BlackAndWhite.HeapHistogram3D = {
        CutLinecolor: null,
        InnerLabelColor: null
    };
}

DChart.HeapHistogram3D = DChart.getCore().__extends({ GraphType: 'HeapHistogram3D' });
DChart.HeapHistogram3D._spreadSkin = function (newOps, skin) {
...
DChart.HeapHistogram3D._getDefaultOptions = function (originalCommonOptions) {
...
DChart.HeapHistogram3D._getCheckOptions = function () {
    return {
...
DChart.HeapHistogram3D._drawgraphic = function (inner, graphicID, innerData, options) {
