...
DChart.QueueHistogram = DChart.getCore().__extends({ GraphType: 'QueueHistogram' });
DChart.QueueHistogram._spreadSkin = function (newOps, skin) {
    newOps.label = {};
    newOps.label.color = skin.LabelColor || null;
};
DChart.QueueHistogram._getDefaultOptions = function (originalCommonOptions) {
...
DChart.QueueHistogram._getCheckOptions = function () {
    return {
...
DChart.QueueHistogram._drawgraphic = function (inner, graphicID, innerData, options) {
