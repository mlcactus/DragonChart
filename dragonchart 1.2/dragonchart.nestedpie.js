...
DChart.NestedPie = DChart.getCore().__extends({ GraphType: 'NestedPie' });
DChart.NestedPie._spreadSkin = function (newOps, skin) {
...
DChart.NestedPie._getDefaultOptions = function (originalCommonOptions) {
...
DChart.NestedPie._getCheckOptions = function () {
    return {
...
DChart.NestedPie._drawgraphic = function (inner, graphicID, innerData, options) {
