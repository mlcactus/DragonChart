...
DChart.Bar = DChart.getCore().__extends({ GraphType: 'Bar' });
DChart.Bar._spreadSkin = function (newOps, skin) {
    newOps.topLabel = {};
    newOps.topLabel.color = skin.TopLabelColor || null;
};
DChart.Bar._getDefaultOptions = function (originalCommonOptions) {
...
DChart.Bar._getCheckOptions = function () {
    return {
