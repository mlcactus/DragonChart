if (!window.DChart) {
    ...
    DChart.Const.Skins.BlackAndWhite.Histogram3D = {
        TopLabelColor: null
    };
}
DChart.Histogram3D = DChart.getCore().__extends({ GraphType: 'Histogram3D' });
DChart.Histogram3D._spreadSkin = function (newOps, skin) {
    newOps.topLabel = {};
    newOps.topLabel.color = skin.TopLabelColor || null;
};
DChart.Histogram3D._getDefaultOptions = function (originalCommonOptions) {
...
DChart.Histogram3D._getCheckOptions = function () {
    return {
...
DChart.Histogram3D._drawgraphic = function (inner, graphicID, innerData, options) {
