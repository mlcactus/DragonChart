...
DChart.MultiRing = DChart.getCore().__extends({ GraphType: 'MultiRing' });
DChart.MultiRing._spreadSkin = function (newOps, skin) {
...
DChart.MultiRing._getDefaultOptions = function (originalCommonOptions) {
...
DChart.MultiRing._getCheckOptions = function () {
    return {
...
DChart.MultiRing._drawgraphic = function (inner, graphicID, innerData, options) {
