...
DChart.Pie = DChart.getCore().__extends({ GraphType: 'Pie' });
DChart.Pie._spreadSkin = function (newOps, skin) {
...
DChart.Pie._getDefaultOptions = function (originalCommonOptions) {
...
DChart.Pie._getCheckOptions = function () {
    return {
...
DChart.Pie._drawgraphic = function (inner, graphicID, innerData, options) {
