...
DChart.RangeHistogram = DChart.getCore().__extends({ GraphType: 'RangeHistogram' });
DChart.RangeHistogram._spreadSkin = function (newOps, skin) {
    newOps.smallLabel = {};
    newOps.smallLabel.color = skin.SmallLabelColor || null;
    newOps.bigLabel = {};
    newOps.bigLabel.color = skin.BigLabelColor || null;
};
DChart.RangeHistogram._getDefaultOptions = function (originalCommonOptions) {
...
DChart.RangeHistogram._getCheckOptions = function () {
    return {
...
DChart.RangeHistogram._drawgraphic = function (inner, graphicID, innerData, options) {
