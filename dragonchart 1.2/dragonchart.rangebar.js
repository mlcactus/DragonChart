if (!window.DChart) {
    ...
    DChart.Const.Skins.BlackAndWhite.RangeBar = {
        SmallLabelColor: null,
        BigLabelColor: null
    };
}
DChart.RangeBar = DChart.getCore().__extends({ GraphType: 'RangeBar' });
DChart.RangeBar._spreadSkin = function (newOps, skin) {
    newOps.smallLabel = {};
    newOps.smallLabel.color = skin.SmallLabelColor || null;
    newOps.bigLabel = {};
    newOps.bigLabel.color = skin.BigLabelColor || null;
};
DChart.RangeBar._getDefaultOptions = function (originalCommonOptions) {
...
DChart.RangeBar._getCheckOptions = function () {
    return {
...
DChart.RangeBar._drawgraphic = function (inner, graphicID, innerData, options) {
