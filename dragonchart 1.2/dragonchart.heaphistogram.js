...
DChart.HeapHistogram = DChart.getCore().__extends({ GraphType: 'HeapHistogram' });
DChart.HeapHistogram._spreadSkin = function (newOps, skin) {
...
DChart.HeapHistogram._getDefaultOptions = function (originalCommonOptions) {
...
DChart.HeapHistogram._getCheckOptions = function () {
    return {
...
DChart.HeapHistogram._drawgraphic = function (inner, graphicID, innerData, options) {
