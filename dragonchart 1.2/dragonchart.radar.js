...
DChart.Radar = DChart.getCore().__extends({ GraphType: 'Radar' });
DChart.Radar._spreadSkin = function (newOps, skin) {
...
DChart.Radar._getDefaultOptions = function (originalCommonOptions) {
...
DChart.Radar._getCheckOptions = function () {
    return {
...
DChart.Radar._drawgraphic = function (inner, graphicID, innerData, options) {
