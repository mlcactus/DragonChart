...
DChart.HeapBar = DChart.getCore().__extends({ GraphType: 'HeapBar' });
DChart.HeapBar._spreadSkin = function (newOps, skin) {
    newOps.bar = {}; newOps.label = {};
    newOps.bar.cutlinecolor = skin.CutLinecolor || null;
    newOps.label.color = skin.InnerLabelColor || null;
};
DChart.HeapBar._getDefaultOptions = function (originalCommonOptions) {
...
DChart.HeapBar._getCheckOptions = function () {
    return {
...
DChart.HeapBar._drawgraphic = function (inner, graphicID, innerData, options) {
