...
DChart.Histogram = DChart.getCore().__extends({ GraphType: 'Histogram' });
DChart.Histogram._spreadSkin = function (newOps, skin) {
    newOps.topLabel = {};
    newOps.topLabel.color = skin.TopLabelColor || null;
};
DChart.Histogram._getDefaultOptions = function (originalCommonOptions) {
...
DChart.Histogram._getCheckOptions = function () {
    return {
...
DChart.Histogram._drawgraphic = function (inner, graphicID, innerData, options) {
