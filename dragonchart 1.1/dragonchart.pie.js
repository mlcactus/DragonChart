...
DChart.Pie = DChart.getCore().__extends({
    ...
    Draw: function (_data, ops) {
        ...
        var pieRadius = options.radius && options.radius < radiusInfo.maxRadius ? options.radius : radiusInfo.maxRadius;
        inner.coordinates.draw = radiusInfo.coordinate;
        inner.coordinates.pie = { radius: pieRadius, centerX: radiusInfo.centerX, centerY: radiusInfo.centerY };
        var segmentTotal = inner._computeSegmentTotal().segmentTotal;
