        ...
        var redrawSegments = function () {
            if (axisData.multiple) {
                for (var i = 0; i < redraw.nodeinfos.length; i++) {
                    ...
                    drawlineFunction(points, redraw.nodeinfos[i].linewidth, redraw.nodeinfos[i].linecolor, invertAxis);
                    for (var j = 0; j < points.length; j++) {
                ...
                drawlineFunction(points, redraw.linewidth, redraw.linecolor, invertAxis);
                for (var j = 0; j < points.length; j++) {
